          ...
          <div className={styles.containerHeaderLeft}>
            <div className={styles.containerHeaderLogo}>
              <div className={styles.title}>
                <svg class='logo' id="logo_svg" data-name="Logo SVG" xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 80 20">
                  <title>500px</title>
                  <path
            ...
            <div className={styles.containerHeaderNavbar}>
              <ul>
                ...
                <li><a href="#" onClick={toggleMenu} style={{ display: "flex", alignItems: "center" }}>Licensing
