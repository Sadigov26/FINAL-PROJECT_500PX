                    ...
                    <div className={styles.LicensingStartingContainerBottom}>
                        ...
                        <div className={styles.LicensingBottomDesk}>
                            <div className={styles.LicensingBottomDesk} id='#become-a-contributor'>
                                ...
                                <a style={{ width: "100%", textAlign: "end", paddingTop: "30px", color: '#2995F9', textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "end", gap: "10px" }} href="/licensing/requirements">Submission requirements <FaChevronRight /></a>
                            </div>
