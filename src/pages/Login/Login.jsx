        ...
        <div>
            ...
            <div className={styles.Login}>
                <div className={styles.LoginContainer}>
                    ...
                    <form className={styles.LoginContainerInput} onSubmit={handleLogin}>
                    ...
                    <div className={styles.LoginContainerSocial}>
                        <a href="#">
                            <FaApple className={styles.iconsLogin} /> Log in with Apple
                        </a>
                        <a href="#" style={{ backgroundColor: '#3C5A96', border: '2px solid #3C5A96' }}>
                            <FaFacebook className={styles.iconsLogin} /> Log in with Facebook
                        </a>
                        <a href="#" style={{ backgroundColor: 'white', color: '#6D7378', border: '2px solid #6D7378' }}>
                            <svg className={styles.iconsLogin} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
