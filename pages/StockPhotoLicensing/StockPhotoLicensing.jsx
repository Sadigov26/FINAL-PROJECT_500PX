                    ...
                    <div className={styles.LicensingStartingContainerBottom}>
                        ...
                        <div className={styles.LicensingBottomDesk}>
                            <div className={styles.section}>
                                ...
                                <a style={{ width: "100%", textAlign: "end", paddingTop: "30px", color: '#2995F9', textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "end", gap: "10px" }} href="/contribute#become-a-contributor">Become a contributor <FaChevronRight /></a>
                            </div>
                        </div>
                    </div>
                </div>
